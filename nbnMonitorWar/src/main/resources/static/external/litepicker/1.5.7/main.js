        ...
        ([function (t, e, i) {
                    ...
                    var o = function () {
                        ...
                        return t.parseDateTime = function (e, i, o) {
                            ...
                            if (e instanceof Date)
                                return new Date(e);
                            if (e instanceof t)
                                return e.clone().getDateInstance();
                            if (/^-?\d{10,}$/.test(e))
                    ...
                    h = function (t) {
                        ...
                        e.prototype.onInit = function () {
                            ...
                            this.options.mobileFriendly && (this.backdrop = document.createElement("div"), this.backdrop.className = p.litepickerBackdrop, this.backdrop.addEventListener("click", this.hide()), this.options.element && this.options.element.parentNode && this.options.element.parentNode.appendChild(this.backdrop), window.addEventListener("orientationchange", (function (e) {
                                        var i = function () {
                                ...
                                if (this.shouldShown(i))
                                    ...
                                    if (i.classList.contains(p.buttonPreviousMonth)) {
                                        ...
                                        if (this.options.splitView) {
                                            ...
                                            h = c.findNestedMonthItem(u),
                                            d = 1
                                        }
                                        return this.calendars[h].setMonth(this.calendars[h].getMonth() - d),
                    ...
                    a = function () {
                        ...
                        t.prototype.renderMonth = function (t) {
                            ...
                            if (this.options.dropdowns.months) {
                                ...
                                for (var h = 0; h < 12; h += 1) {
                                    ...
                                    d.value = String(h),
                                    d.text = u.toLocaleString(this.options.lang, {
                                        month: "long"
                                    }),
                            ...
                            if (this.options.dropdowns.years) {
                                ...
                                if (t.getFullYear() > y)
                                    (d = document.createElement("option")).value = String(t.getFullYear()), d.text = String(t.getFullYear()), d.selected = !0, d.disabled = !0, f.appendChild(d);
                                for (h = y; h >= g; h -= 1) {
                                    var d = document.createElement("option"),
                        ...
                        t.prototype.renderWeekNumber = function (t) {
                            ...
                            return e.className = s.weekNumber,
                            e.innerHTML = 53 === i && 0 === t.getMonth() ? "53 / 1" : i,
                            e
                        },
                        t.prototype.renderTooltip = function () {
                            var t = document.createElement("div");
                            return t.className = s.containerTooltip,
                            t
                        },
                    ...
                    function u(t, e, i) {
                        ...
                        n = i.media,
                        s = i.sourceMap;
                        if (n && t.setAttribute("media", n), s && btoa && (o += "\n/*# sourceMappingURL=data:application/json;base64,".concat(btoa(unescape(encodeURIComponent(JSON.stringify(s)))), " */")), t.styleSheet)
                    ...
                    function g(t, e) {
                        ...
                        if (e.singleton) {
                            ...
                            i = p(e), o = u.bind(null, i, e), n = function () {
                                !function (t) {
                    ...
                    r.Litepicker.prototype.show = function (t) {
                        ...
                        if (this.triggerElement = e, this.options.inlineMode)
                            return this.picker.style.position = "static", this.picker.style.display = "inline-block", this.picker.style.top = null, this.picker.style.left = null, this.picker.style.bottom = null, void(this.picker.style.right = null);
                        ...
                        if (this.options.mobileFriendly && l.isMobile()) {
                            ...
                            return this.picker.style.top = "calc(50% - " + n.height / 2 + "px)",
                        ...
                        if (this.options.parentEl) {
                            ...
                            h = window.scrollX || window.pageXOffset, d = window.scrollY || window.pageYOffset, p + r.height > window.innerHeight && s.top - r.height > 0 && (u = s.top - r.height), c + r.width > window.innerWidth && s.right - r.width > 0 && (m = s.right - r.width);
                    ...
                    r.Litepicker.prototype.setDate = function (t) {
                        this.setStartDate(t),
                        "function" == typeof this.options.onSelect && this.options.onSelect.call(this, this.getDate())
                    },
